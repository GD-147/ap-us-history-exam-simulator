...
(async function () {
  ...
  if (section.type === "frq" || section.type === "written") {
    ...
    if (mode === "practice") {
      ...
      metaText = chosen.title || "AP U.S. History Written-Response Section";
    }
    ...
    qs("essayDesc").textContent = mode === "practice"
      ? "Untimed written-response practice. Use this to rehearse AP U.S. History source analysis, historical reasoning, and written explanations."
